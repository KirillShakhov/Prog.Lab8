package clientfx.Commands.Utils.Creaters;

import clientfx.BasicClasses.Album;
import clientfx.BasicClasses.Coordinates;
import clientfx.BasicClasses.MusicBand;
import clientfx.BasicClasses.MusicGenre;
import clientfx.ClientController;
import clientfx.Commands.Utils.Readers.EnumReaders.*;
import clientfx.Commands.Utils.Readers.NotPrimitiveReaders.*;
import clientfx.Commands.Utils.Readers.PrimitiveAndReferenceReaders.*;
        ...
        if (validateArrayMusicBand(parameters)) {
            ...
            try {
                return new MusicBand(0L,parameters.get(0),
                        ...
                        new Album(parameters.get(7), Integer.parseInt(parameters.get(8)), Integer.parseInt(parameters.get(9)), Integer.parseInt(parameters.get(10))), ClientController.name);
